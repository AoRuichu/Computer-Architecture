...
set ::env(VERILOG_FILES) ../Verilog/RTL_SOLUTION4_pipeline_hazard_MULT3/*.v
...
set ::env(EXTRA_LEFS)      [list OpenRAM_output/sky130_sram_2rw_64x128_64.lef OpenRAM_output/sky130_sram_2rw_32x128_32.lef]
set ::env(EXTRA_GDS_FILES) [list OpenRAM_output/sky130_sram_2rw_32x128_32.gds OpenRAM_output/sky130_sram_2rw_64x128_64.gds]
